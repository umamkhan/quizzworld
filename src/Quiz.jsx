...
const Quiz = () => {
	...
	" text-3xl font-bold text-slate-800 dark:text-slate-100 text-blue-700 text-bold left-0 p-5 tracking-widest flex items-center justify-center";

	return (
		<div className=" w-full lg:max-w-xl justify-center ">
			<h1 className={quizTitleStyle}>Quizz World</h1>
			...
			{quizzes.length === 0 || isloading ? (
				...
				<div className="">
					<div className=" text-blue-400  text-2xl flex justify-between mt-8  ">
						<span className="text-3xl">{currentQuiz?.category}</span>
						<span>
